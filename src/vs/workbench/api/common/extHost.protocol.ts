...
export interface MainThreadTestingShape {
	...
	$updateTestStateInRun(runId: string, taskId: number, testId: string, state: TestResultState, duration?: number): void;
	/** Appends a message to a test in the run. */
	$appendTestMessageInRun(runId: string, taskId: number, testId: string, message: ITestMessage): void;
	/** Appends raw output to the test run.. */
	$appendOutputToRun(runId: string, taskId: number, output: VSBuffer): void;
	...
	/** Signals that a test run finished. */
